...
type WechatPhysiqueOrder struct {
	...
	EighteenMethod    string `form:"eighteenMethodOrder"  search:"type:order;column:eighteen_method;table:wechat_physique"`
	WellnessMethod    string `form:"wellnessMethodOrder"  search:"type:order;column:wellness_method;table:wechat_physique"`
	...
	CreateBy          string `form:"createByOrder"  search:"type:order;column:create_by;table:wechat_physique"`
	UpdateBy          string `form:"updateByOrder"  search:"type:order;column:update_by;table:wechat_physique"`
}
...
type WechatPhysiqueInsertReq struct {
	...
	AcupunctureMethod string `json:"acupunctureMethod" comment:"三才河洛灸"`
	EighteenMethod    string `json:"eighteenMethod" comment:"十八宝"`
	WellnessMethod    string `json:"wellnessMethod" comment:"日常养生"`
...
func (s *WechatPhysiqueInsertReq) Generate(model *models.WechatPhysique) {
	...
	model.EighteenMethod = s.EighteenMethod
	model.WellnessMethod = s.WellnessMethod
